...
public class TestProvider extends AndroidTestCase {
    ...
    public void testBasicWeatherQuery() {
        ...
        ContentValues weatherValues = TestUtilities.createMoviesValues("Highest Rated");
    ...
    public void testBasicLocationQueries() {
        ...
        long locationRowId = TestUtilities.insertMoviesValues(mContext);
        ...
        if ( Build.VERSION.SDK_INT >= 19 ) {
            assertEquals("Error: Location Query did not properly set NotificationUri",
                    locationCursor.getNotificationUri(), MoviesEntry.CONTENT_URI);
        }
    }
...
//    }
    ...
    static ContentValues[] createBulkInsertMoviesValues(String tag) {

        ContentValues[] returnContentValues = new ContentValues[BULK_INSERT_RECORDS_TO_INSERT];

        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {
            ContentValues moviesValues = new ContentValues();
            moviesValues.put(MoviesEntry.COLUMN_TITLE_KEY, "Batman");
            moviesValues.put(MoviesEntry.COLUMN_POSTER_KEY, "dfdfdfdfdfd.jpg");
            moviesValues.put(MoviesEntry.COLUMN_SUMMARY_KEY, "Blah");
            moviesValues.put(MoviesEntry.COLUMN_RELEASE_DATE_KEY, "blah");
            moviesValues.put(MoviesEntry.COLUMN_RATING_KEY,"Blah");
            moviesValues.put(MoviesEntry.COLUMN_TAG_KEY, tag);
