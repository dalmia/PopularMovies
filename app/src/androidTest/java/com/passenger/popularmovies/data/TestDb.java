...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        // if this fails, it means that the database doesn't contain the movies entry tables
        assertTrue("Error: Your database was created without the movies entry table",
